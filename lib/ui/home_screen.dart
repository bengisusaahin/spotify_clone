                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          height: 133,
                          width: 133,
                          child: Image.asset("assets/images/home/Upbeat-Mix.jpg"),
                        ),
                        const SizedBox(
                          height: 12,
                        ),
                  ...
                  Column(
                    ...
                    children: [
                      SizedBox(
                        height: 133,
                        width: 133,
                        child: Image.asset("assets/images/home/Daily-Mix-1.jpg"),
                      ),
                      const SizedBox(
                        height: 12,
                      ),
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          height: 133,
                          width: 133,
                          child: Image.asset("assets/images/home/american-dream.jpg"),
                        ),
                        const SizedBox(
                          height: 12,
                        ),
                  ...
                  const Column(
                    children: [
                      CircleAvatar(
                        radius: 65,
                        backgroundImage: AssetImage("assets/images/artists/JID.jpg"),
                      ),
                      SizedBox(
                        height: 12,
                      ),
                  ...
                  const Column(
                    children: [
                      CircleAvatar(
                        radius: 75,
                        backgroundImage:
                            AssetImage("assets/images/artists/Kendrick-Lamar.jpg"),
                      ),
                      SizedBox(
                        height: 12,
                      ),
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          width: 153,
                          child:
                              Image.asset("assets/images/home/For-All-The-Dogs.jpg"),
                        ),
                        const SizedBox(
                          height: 10,
                        ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      height: 55,
                      width: (MediaQuery.of(context).size.width / 1.77) - 45 > 0
                          ? (MediaQuery.of(context).size.width / 1.77) - 45
                          : 0,
                      decoration: const BoxDecoration(
                        color: MyColors.darGreyColor,
                        borderRadius: BorderRadius.all(
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              ...
                              Image.asset(
                                'assets/icon/icon_heart_white.png',
                                height: 20,
                                width: 20,
                              ),
                            ],
